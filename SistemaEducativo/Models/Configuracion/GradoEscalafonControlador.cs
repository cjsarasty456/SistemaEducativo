...
{
    public class GradoEscalafonViewModel
    {
        public int? Id { get; set; }
        [Required(ErrorMessage = "El Grado Escalafón es requerido")]
        [Display(Name = "Grado Escalafón")]
        public string Nombre { get; set; }
    }
    public class GradoEscalafonControlador
    {
        public static List<GradoEscalafonViewModel> ConsultaListaInstitucionEducativa()
        {
            using (ConfiguracionDataContext db = new ConfiguracionDataContext())
            {
                var consulta = from G in db.GradoEscalafon
                               select new GradoEscalafonViewModel
                               {
                                   Id = G.Id,
                                   Nombre = G.Nombre
                               };
