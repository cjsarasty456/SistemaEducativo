...
{
    public class TipoVinculacionViewModel
    {
        public int? Id { get; set; }
        [Required(ErrorMessage = "Tipo Vinculación es requerido")]
        [Display(Name = "Tipo Vinculación")]
        public string Nombre { get; set; }
    }
    public class TipoVinculacionControlador
    {
        public static List<TipoVinculacionViewModel> ConsultaListaTipoVinculacion()
        {
            using (ConfiguracionDataContext db = new ConfiguracionDataContext())
            {
                var consulta = from T in db.TipoVInculacion
                               orderby T.TipoVinculacion1 ascending
                               select new TipoVinculacionViewModel
                               {
                                   Id = T.IdVinculacion,
                                   Nombre = T.TipoVinculacion1
                               };
