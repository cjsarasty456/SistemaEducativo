...
function MatriculaInstiucionAnterior() {
    var MatriculadoInstitucionAnterior = document.getElementById("CmpMatriculadoInstitucionAnterior").value;
    var CampoCual = document.getElementById("ContenedorMatriculadoInstitucionAnteriorCual");
    var CampoPorque = document.getElementById("ContenedorMatriculadoInstitucionAnteriorPorque");
    CampoCual.value = "";
    CampoPorque.value = "";
    if (MatriculadoInstitucionAnterior=="true") {
        CampoCual.removeAttribute("style");
        CampoPorque.setAttribute("style", "display:none");
        
    } else {
        CampoPorque.removeAttribute("style");
        CampoCual.setAttribute("style", "display:none");
    }
}